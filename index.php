...
class Person {
  ...
  public function __construct($name, $middlename, $lastname, $gender, $father = null, $mother = null ) {// $partner = null - значение по умолчанию
    $this->name = $name;
  ...
  protected function die() { 
    echo $this->getName()." Никогда не умрет :)";
  }
  ...
  public function marry($person) {
    ...
    if ($person->getGender() =="F") {
      $person->setLastname($this->getLastname()."a");
    } else {
